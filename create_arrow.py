...
def find_road_y(image):
    itemindex = np.where(image == 90)
...
def paint_path(image,cali_top1,cali_bot1):
    avg_list = []
    i = cali_top1
    for row in image[cali_top1:cali_bot1]:
...
# # List of constants
# img = cv2.imread(
#     'Test Data\color_labels\\val\\7d6c1119-00000000_train_color.png', 1) # Read image.
